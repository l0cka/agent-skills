...
For fragmented markets, label volume as consolidated, venue-specific, lit-only,
or inclusive of auctions and off-market reports. Use a consistent trading
calendar and adjustment policy.

## Baselines

Start with rolling mean and median estimates over several historical windows.
The median often resists event spikes. The mean may better represent
...
Check whether published volume includes the user's own executions. Otherwise the
published volume can mechanically overstate participation.
