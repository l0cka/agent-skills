...
- later revision status.
- transformation window.
- relationship to the label horizon.
- behavior when missing.

Common leaks include final-day volume in an intraday forecast and close prices in
an earlier decision. They also include revised fundamentals, fill-derived
features used to predict the same fill, random splitting of overlapping windows,
and preprocessing fit on the full sample.
...
Run them inside the training procedure. They cannot justify a final claim by
themselves.
